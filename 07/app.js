...
/////////////////////////
  function makeTrees() {
    moveBox(newGameObject(p7, 'tree', "url('img/tree.png')"), 6, -16, 8, 16);
    moveBox(newGameObject(p7, 'tree', "url('img/tree.png')"), 10, 24, 8, 16);
  };
/////////////////////////
...
function moveBox(element, startL, endL, endW, endH) {
  ...
  let moveIt = setTimeout(function move() {
    if (t < refreshFactor) {
      ...
      box.style.transitionDuration = (200000 / speed) / refreshFactor + 'ms';
    ...
    moveIt = setTimeout(move, (200000 / speed) / refreshFactor)
  }, (200000 / speed) / refreshFactor);
};
/////////////////////////////////
const horizon = 3 * h;
const refreshFactor = 20;
...
let moveTrees = setTimeout(function move() {
  ...
  moveTrees = setTimeout(move, treeInt);
      ...
      //   makeTrees();
      // };
      console.log('speed ' + speed.toFixed(2), speedChange, 'treeInt ' + treeInt.toFixed(2), 'treesMade ' + treesMade)
}, treeInt);
/////////////////////////
